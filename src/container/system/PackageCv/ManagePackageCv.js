            ...
            <div className="col-12 grid-margin">
                <div className="card">
                    <div className="card-body">
                        <h4 className="card-title" style={{textTransform:'uppercase'}}>Danh sách các gói xem hồ sơ ứng viên</h4>
                        <Input.Search onSearch={handleSearch} className='mt-3 mb-2' placeholder="Nhập tên gói" allowClear enterButton="Tìm kiếm">
