    ...
    let handleSaveSalaryType = async () => {
        ...
        if (isActionADD === true) {
            ...
            setTimeout(() => {
                ...
                else toast.error("Thêm mức lương thất bại")
            }, 50);
        } else {
            ...
            setTimeout(() => {
                ...
                else toast.error("Cập nhật mức lương thất bại")
            }, 50);
        }
    }
            ...
            <div className="col-12 grid-margin">
                <div className="card">
                    <div className="card-body">
                        ...
                        <h4 className="card-title" style={{textTransform:'uppercase'}}>{isActionADD === true ? 'Thêm mới mức lương' : 'Cập nhật mức lương'}</h4>
                        <br></br>
                            ...
                            <div className="row">
                                <div className="col-md-8">
                                    <div className="form-group row">
                                        <label className="col-sm-3 col-form-label">Tên mức lương</label>
