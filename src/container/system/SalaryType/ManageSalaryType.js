...
const ManageSalaryType = () => {
    ...
    const confirmDelete = (id) => {
        confirm({
            title: 'Bạn có chắc muốn xóa mức lương này này?',
            ...
            <div className="col-12 grid-margin">
                <div className="card">
                    <div className="card-body">
                        <h4 className="card-title" style={{textTransform:'uppercase'}}>Danh sách mức lương</h4>
                        <Input.Search onSearch={handleSearch} className='mt-3 mb-2' placeholder="Nhập tên mức lương" allowClear enterButton="Tìm kiếm">
                                            ...
                                            return (
                                                <tr key={index}>
                                                    ...
                                                    <td style={{ width: '100px', textAlign: 'center' }}>
                                                        <Link style={{ color: '#4B49AC', marginRight: '10px' }} to={`/admin/edit-work-type/${item.code}/`}><i className='fa fa-edit'></i></Link>
                                                        &nbsp; &nbsp;
