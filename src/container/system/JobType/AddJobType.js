    ...
    let handleSaveJobType = async () => {
        ...
        if (isActionADD === true) {
            ...
            setTimeout(() => {
                ...
                else toast.error("Thêm ngành nghề thất bại")
            }, 50);
        } else {
            ...
            setTimeout(() => {
                ...
                else toast.error("Cập nhật ngành nghề thất bại")
            }, 50);
        }
    }
            ...
            <div className="col-12 grid-margin">
                <div className="card">
                    <div className="card-body">
                        ...
                        <h4 className="card-title" style={{textTransform:'uppercase'}}>{isActionADD === true ? 'Thêm mới ngành nghề' : 'Cập nhật ngành nghề'}</h4>
                        <br></br>
                            ...
                            <div className="row">
                                <div className="col-md-8">
                                    <div className="form-group row">
                                        <label className="col-sm-3 col-form-label">Tên ngành nghề</label>
