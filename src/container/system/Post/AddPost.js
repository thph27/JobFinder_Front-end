                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            {inputValues.isActionADD === true && user.roleCode !== "ADMIN" && (
                                <div className='company-remaining-posts'>
                                    <h4>Công ty còn:</h4>
                                    <div className="post-count" style={{marginLeft:'4px'}}>
                                        <i className="fas fa-file-alt"></i>
                                        <p>
                                            <span className="normal-post">{companyPostAllow.nonHot}</span> bài đăng bình thường
                                        </p>
                                    </div>
                                    <div className="post-count">
                                        <i className="fas fa-star"></i>
                                        <p>
                                            <span className="hot-post">{companyPostAllow.hot}</span> bài đăng nổi bật
                                        </p>
                                    </div>
                                </div>
                            )}
                            <form className="form-sample">
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            <label className="col-sm-3 col-form-label">Số lượng tuyển</label>
                                            <div className="col-sm-9">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            <label className="col-sm-3 col-form-label">Thời gian kết thúc</label>
                                            <div className="col-sm-9">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <div className="form-group row">
                                            <label className="col-sm-3 col-form-label">Hình thức làm việc</label>
                                            <div className="col-sm-9">
                                ...
                                {inputValues.isActionADD && (<>
                                    <div className='row'>
                                        <div className="col-md-6">
                                            <div className="form-group row">
                                                <label className="col-sm-3 col-form-label">Bài đăng nổi bật</label>
                                                <div className="col-sm-9">
                                                    <input disabled={user?.roleCode === "ADMIN" ? true : false} onChange={handleIsHot} checked={inputValues.isHot} style={{ marginTop: '18px', width: '18px', height: '18px' }} type={'checkbox'}></input>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        <label className="form-label" style={{marginBottom:'30px'}}>Chi tiết tuyển dụng</label>
