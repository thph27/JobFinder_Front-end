            ...
            <div className="col-12 grid-margin">
                <div className="card">
                    <div className="card-body">
                        <h4 className="card-title" style={{textTransform:'uppercase'}}>Danh sách hình thức làm việc</h4>
                        <Input.Search onSearch={handleSearch} className='mt-4 mb-2' placeholder="Nhập tên hình thức" allowClear enterButton="Tìm kiếm">
