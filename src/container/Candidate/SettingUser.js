                        ...
                        <form className="form-sample">
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        <label className="col-sm-3 col-form-label" style={{paddingLeft: '50px'}}>Lĩnh vực</label>
                                ...
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        <label className="col-sm-3 col-form-label" style={{textAlign: 'right'  }}>Mức lương mong muốn</label>
                                        <div className="col-sm-9 mt-3">
                                        <Select
                            ...
                            <div className='row'>
                                <div className='col-md-12'>
                                    <div className="form-group row">
                                        <label className="col-sm-3 col-form-label" style={{paddingLeft: '40px', paddingRight: '0'}}>Chuyên môn</label>
                                        <div className="col-sm-3 mt-3" style={{ marginLeft: '-186px' }}>
                                            <Select
                                                ...
                                                placeholder="Chọn chuyên môn của bạn"
                                                onChange={handleChange}
                                                options={listSkills}
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        <label className="col-sm-3 col-form-label" style={{paddingLeft: '50px', paddingRight: '0'}}>Khu vực làm việc</label>
                                        <div className="col-sm-9 mt-3">
                                            <Select
                                ...
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        <label className="col-sm-3 col-form-label" style={{ paddingRight: 0, paddingLeft: '40px'}}>Kinh nghiệm làm việc</label>
                                        <div className="col-sm-9 mt-3">
                                        <Select
                            ...
                            <div className='row'>
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        <label className="col-sm-3 col-form-label" style={{paddingLeft: '50px', paddingRight: '0'}}>Nhận mail công việc</label>
                                        <div className="col-sm-9 mt-3">
                                            <input name="isTakeMail" onChange={handleOnChangeCheckBox} checked={inputValues.isTakeMail} style={{width: '18px', height: '18px' }} type="checkbox"></input>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group row">
                                        <label className="col-sm-3 col-form-label" style={{paddingLeft: '50px', paddingRight: '0'}}>CV gửi lên</label>
                            ...
                            <div className="button-group">
                                <button type="button" onClick={() => window.location.href = '/'} className="btn1 btn1-secondary1">
                                    <i className="ti-arrow-left"></i>
                                    <span>Quay lại</span>
                                </button>
                                <button type="button" onClick={() => handleSaveUser()} className="btn1 btn1-primary1">
