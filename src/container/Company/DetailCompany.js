...
const DetailCompany = () => {
    ...
    return (
        <div className='container-detail-company'>
            <div className="company-cover" style={{paddingTop: '30px'}}>
                <div className="container">
                    <div className="cover-wrapper">
                        <img src={dataCompany.coverimage} alt="" className="img-responsive cover-img" width="100%" height="236px"/>
                    </div>
                    <div className="company-detail-overview" style={{padding: '20px'}}>
                        <div id="company-logo">
                        ...
                        <div className="box-follow">
                            <a style={{
                                background: dataCompany.censorData && (
                                    dataCompany.censorData.code === 'CS2' ? '#FFE920' :  // Màu vàng cho trạng thái chờ duyệt
                                    dataCompany.censorData.code === 'CS3' ? '#FF4444' :  // Màu đỏ cho trạng thái từ chối
                                    dataCompany.censorData.code === 'CS1' ? '#4CAF50' : '' // Màu xanh lá cho trạng thái đã duyệt
                                ),
                                color: dataCompany.censorData && dataCompany.censorData.code === 'CS1' ? 'white' : 'black',
                                padding: '10px 20px',
                                borderRadius: '5px',
                                fontSize: '14px',
                                ...
                                {dataCompany.censorData && dataCompany.censorData.value}
                            </a>
                        </div>
                    </div>
                </div>
                                                            ...
                                                            <div style={{minWidth:'100px'}} className="mr-auto text-right">
                                                                <p className="deadline">
                                                                    ...
                                                                    {CommonUtils.formatDate(item.timeEnd) <= 0 ?
                                                                        <div>Hết hạn ứng tuyển</div> : <div>Còn <strong>{CommonUtils.formatDate(item.timeEnd)}</strong> ngày ứng tuyển</div>
                                                                    }
                                                                </p>
                                                            </div>
                                                        </div>
