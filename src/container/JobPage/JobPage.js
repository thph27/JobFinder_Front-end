...
const JobPage = () => {
    ...
    return (
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="hero-cap text-center">
                                        <h2 style={{textTransform: 'uppercase', fontSize: '50px'}}>Tìm kiếm công việc bạn yêu thích ngay!</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Job List Area Start --> */}
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-tittle text-center" style={{ paddingTop: '70px', fontWeight: 'extrabold' }}>
                                    <h2 style={{ fontSize: '56px', textTransform: 'uppercase' }}>Danh sách các bài đăng</h2>
                                </div>
                            </div>
                        </div>
                <div class="job-listing-area pb-120">
                    <div class="container-fluid" style={{paddingLeft: '150px', paddingRight: '150px'}}>
                        <div class="row">
                            {/* <!-- Left content --> */}
                            <div class="col-xl-3 col-lg-3 col-md-4" style={{}}>
                                <div class="row">
                                    <div class="col-12">
                            ...
                            {/* <!-- Right content --> */}
                            <div class="col-xl-9 col-lg-9 col-md-8" style={{marginTop:'66px'}}>
